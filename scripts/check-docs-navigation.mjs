...
assert.equal(pages.length, 108, "Review guide coverage when adding or removing pages");
...
for (const [id, slugs] of Object.entries({
  ...
  cameras: ["perspective", "cameras", "third-person-camera", "screen-transitions", "photo-mode", "screenshots"],
