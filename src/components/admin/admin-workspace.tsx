...
const NAV = [
  ...
  { href: "/admin/resources", label: "Hub review", group: "Access & safety", icon: ShieldIcon, note: "Review community project pages and inspected package releases." },
  { href: "/admin/resources/reports", label: "Hub reports", group: "Access & safety", icon: ShieldIcon, note: "Investigate community reports and record moderation outcomes." },
