...
export async function GET() {
  ...
  const documents: string[] = [
    [
      ...
      "",
      "Status: pre-alpha. There is no public build and no release date. The server listings on the",
      "website are labelled demo data, not live servers. Everything below describes software under",
      "construction and can change.",
      "",
      site.disclaimer,
    ].join("\n"),
  ];
