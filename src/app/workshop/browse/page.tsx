...
export async function generateMetadata({ searchParams }: { searchParams: Promise<Search> }) {
  ...
  return { ...pageMetadata({ title: "Workshop", description: "Browse scripts, gamemodes, maps, interfaces and tools for your OPEN//77 server, made by the community.", path: "/workshop/browse" }),
