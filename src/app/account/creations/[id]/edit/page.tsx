...
export default async function EditCreationPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <HubShell><HubPageHead kicker="CREATOR WORKSPACE" title="Edit creation" actions={<Link className="btn btn-ghost btn-small" href="/account/creations">All creations</Link>}><p>Changes stay private until they are reviewed.</p></HubPageHead><CreatorEditor id={id} /></HubShell>;
}
